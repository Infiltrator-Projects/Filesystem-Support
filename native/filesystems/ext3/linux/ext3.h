...
/**
 * struct ext3_new_group_input - Private EXT3 state/data structure used by ext3 shared model.
 *
...
/**
 * struct ext3_new_group_data - Private EXT3 state/data structure used by ext3 shared model.
 *
 * Treat fields that mirror persistent media or cross subsystem boundaries
 * as interface contracts rather than incidental layout.
 */
...
/**
 * struct ext3_inode - Private EXT3 state/data structure used by ext3 shared model.
 *
 * Treat fields that mirror persistent media or cross subsystem boundaries
 * as interface contracts rather than incidental layout.
 */
...
/**
 * struct ext3_inode_info - Private EXT3 state/data structure used by ext3 shared model.
 *
 * Treat fields that mirror persistent media or cross subsystem boundaries
 * as interface contracts rather than incidental layout.
 */
...
/**
 * struct ext3_sb_info - Private EXT3 state/data structure used by ext3 shared model.
 *
 * Treat fields that mirror persistent media or cross subsystem boundaries
 * as interface contracts rather than incidental layout.
 */
...
/**
 * struct ext3_dir_entry_2 - Private EXT3 state/data structure used by ext3 shared model.
 *
 * Treat fields that mirror persistent media or cross subsystem boundaries
 * as interface contracts rather than incidental layout.
 */
...
/**
 * struct dir_private_info - Private EXT3 state/data structure used by ext3 shared model.
 *
 * Treat fields that mirror persistent media or cross subsystem boundaries
 * as interface contracts rather than incidental layout.
 */
...
/**
 * ext3_group_first_block_no - Implements the group first block no operation within the ext3 shared model subsystem.
 *
 * Correctness contract: preserve the locking, lifetime, range and
 * transaction preconditions established by the surrounding EXT3
 * subsystem. Failure handling must follow that subsystem's established
...
extern int  ext3_setattr (struct mnt_idmap *, struct dentry *, struct iattr *);
...
/**
 * ext3_journal_release_buffer - Releases filesystem state and reconciles the corresponding accounting or ownership metadata.
 *
 * Correctness contract: preserve the locking, lifetime, range and
 * transaction preconditions established by the surrounding EXT3
 * subsystem. Failure handling must follow that subsystem's established
...
/**
 * struct mb_cache_entry - Private EXT3 state/data structure used by ext3 shared model.
 *
 * Treat fields that mirror persistent media or cross subsystem boundaries
 * as interface contracts rather than incidental layout.
 */
