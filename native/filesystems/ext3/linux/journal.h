...
/**
 * struct journal_header_s - Private EXT3 state/data structure used by embedded jbd contract.
 *
...
/**
 * struct journal_block_tag_s - Private EXT3 state/data structure used by embedded jbd contract.
 *
 * Treat fields that mirror persistent media or cross subsystem boundaries
 * as interface contracts rather than incidental layout.
 */
...
/**
 * struct journal_revoke_header_s - Private EXT3 state/data structure used by embedded jbd contract.
 *
 * Treat fields that mirror persistent media or cross subsystem boundaries
 * as interface contracts rather than incidental layout.
 */
...
/**
 * struct journal_superblock_s - Private EXT3 state/data structure used by embedded jbd contract.
 *
 * Treat fields that mirror persistent media or cross subsystem boundaries
 * as interface contracts rather than incidental layout.
 */
...
/*
 * Linux removed the standalone JBD common header after EXT3 itself was
 * retired.  Keep the original JBD locking contract local to this embedded
 * journal engine instead of depending on JBD2.
 */
...
/**
 * struct handle_s - Private EXT3 state/data structure used by embedded jbd contract.
 *
 * Treat fields that mirror persistent media or cross subsystem boundaries
 * as interface contracts rather than incidental layout.
 */
...
/**
 * struct transaction_s - Private EXT3 state/data structure used by embedded jbd contract.
 *
 * Treat fields that mirror persistent media or cross subsystem boundaries
 * as interface contracts rather than incidental layout.
 */
...
/**
 * struct journal_s - Private EXT3 state/data structure used by embedded jbd contract.
 *
 * Treat fields that mirror persistent media or cross subsystem boundaries
 * as interface contracts rather than incidental layout.
 */
...
/**
 * tid_gt - Implements the tid gt operation within the embedded jbd contract subsystem.
 *
 * Correctness contract: preserve the locking, lifetime, range and
 * transaction preconditions established by the surrounding EXT3
 * subsystem. Failure handling must follow that subsystem's established
...
/**
 * jbd_space_needed - Implements the space needed operation within the embedded jbd contract subsystem.
 *
 * Correctness contract: preserve the locking, lifetime, range and
 * transaction preconditions established by the surrounding EXT3
 * subsystem. Failure handling must follow that subsystem's established
