 ...
 */
#define EXT4_FLAGS_SIGNED_HASH		0x0001  /* Signed dirhash in use */
#define EXT4_FLAGS_UNSIGNED_HASH	0x0002  /* Unsigned dirhash in use */
#define EXT4_FLAGS_TEST_FILESYS		0x0004	/* to test development code */
