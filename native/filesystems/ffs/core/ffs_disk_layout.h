#ifndef INFILTRATOR_FFS_CORE_DISK_LAYOUT_H
#define INFILTRATOR_FFS_CORE_DISK_LAYOUT_H

/*
 * Canonical FFS on-disk layout.
 *
...
typedef unsigned char ifs_ffs_disk_u8;
#else
#include <stdint.h>
typedef uint16_t ifs_ffs_disk_be16;
typedef uint32_t ifs_ffs_disk_be32;
typedef uint8_t ifs_ffs_disk_u8;
#endif
...
struct affs_date {
    ifs_ffs_disk_be32 days;
    ifs_ffs_disk_be32 mins;
    ifs_ffs_disk_be32 ticks;
};

struct affs_short_date {
    ifs_ffs_disk_be16 days;
    ifs_ffs_disk_be16 mins;
    ifs_ffs_disk_be16 ticks;
};

struct affs_root_head {
    ifs_ffs_disk_be32 ptype;
    ifs_ffs_disk_be32 reserved0;
    ifs_ffs_disk_be32 reserved1;
    ifs_ffs_disk_be32 hash_size;
    ifs_ffs_disk_be32 reserved2;
    ifs_ffs_disk_be32 checksum;
    ifs_ffs_disk_be32 table[];
};

struct affs_root_tail {
    ifs_ffs_disk_be32 bitmap_valid;
    ifs_ffs_disk_be32 bitmap_blocks[AFFS_ROOT_BMAPS];
    ifs_ffs_disk_be32 bitmap_extension;
    struct affs_date root_change;
    ifs_ffs_disk_u8 disk_name[32];
    ifs_ffs_disk_be32 reserved0;
    ifs_ffs_disk_be32 reserved1;
    struct affs_date disk_change;
    struct affs_date disk_create;
    ifs_ffs_disk_be32 reserved2;
    ifs_ffs_disk_be32 reserved3;
    ifs_ffs_disk_be32 directory_cache;
    ifs_ffs_disk_be32 stype;
};
...
struct affs_head {
    ifs_ffs_disk_be32 ptype;
    ifs_ffs_disk_be32 key;
    ifs_ffs_disk_be32 block_count;
    ifs_ffs_disk_be32 reserved;
    ifs_ffs_disk_be32 first_data;
    ifs_ffs_disk_be32 checksum;
    ifs_ffs_disk_be32 table[];
};
...
struct affs_tail {
    ifs_ffs_disk_be32 reserved0;
    ifs_ffs_disk_be16 uid;
    ifs_ffs_disk_be16 gid;
    ifs_ffs_disk_be32 protect;
    ifs_ffs_disk_be32 size;
    ifs_ffs_disk_u8 comment[92];
    struct affs_date change;
    ifs_ffs_disk_u8 name[32];
    ifs_ffs_disk_be32 reserved1;
    ifs_ffs_disk_be32 original;
    ifs_ffs_disk_be32 link_chain;
    ifs_ffs_disk_be32 reserved2[5];
    ifs_ffs_disk_be32 hash_chain;
    ifs_ffs_disk_be32 parent;
    ifs_ffs_disk_be32 extension;
    ifs_ffs_disk_be32 stype;
};
...
struct slink_front {
    ifs_ffs_disk_be32 ptype;
    ifs_ffs_disk_be32 key;
    ifs_ffs_disk_be32 reserved[3];
    ifs_ffs_disk_be32 checksum;
    ifs_ffs_disk_u8 symname[];
};

struct affs_data_head {
    ifs_ffs_disk_be32 ptype;
    ifs_ffs_disk_be32 key;
    ifs_ffs_disk_be32 sequence;
    ifs_ffs_disk_be32 size;
    ifs_ffs_disk_be32 next;
    ifs_ffs_disk_be32 checksum;
    ifs_ffs_disk_u8 data[];
};
