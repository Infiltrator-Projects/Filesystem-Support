...
#define IFS_OFS_AOPS_WRITE_CONTEXT const struct kiocb *iocb
#define IFS_OFS_AOPS_WRITE_CONTEXT_ARG iocb
#define IFS_OFS_INODE_IS_NEW(inode) \
    ((inode_state_read_once(inode) & I_NEW) != 0)
#define IFS_OFS_MKDIR_RETURN struct dentry *
#define IFS_OFS_MKDIR_FAILURE(error) ERR_PTR(error)
#define IFS_OFS_MKDIR_SUCCESS NULL
#else
#define IFS_OFS_AOPS_WRITE_CONTEXT struct file *file
#define IFS_OFS_AOPS_WRITE_CONTEXT_ARG file
#define IFS_OFS_INODE_IS_NEW(inode) (((inode)->i_state & I_NEW) != 0)
#define IFS_OFS_MKDIR_RETURN int
#define IFS_OFS_MKDIR_FAILURE(error) (error)
#define IFS_OFS_MKDIR_SUCCESS 0
#endif
