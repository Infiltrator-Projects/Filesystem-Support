/* Infiltrator Filesystem Support — SFS Linux allocation adapter.
 * Free-space/admin-space management and bitmap operations form one allocation
 * responsibility around the canonical SFS engine.
 */
