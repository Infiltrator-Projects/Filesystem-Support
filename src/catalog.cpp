...
const std::vector<FilesystemDescriptor>& catalog()
{
    static const std::vector<FilesystemDescriptor> entries = {
        ...
        {"sfs", "Amiga SFS", "Amiga",
         ...
         {"sfs"}, {}, AccessMode::ReadWrite, SupportProvider::Kernel,"Project-native Linux SFS module based on the pinned ASFS implementation and modernised for current kernels.", true},
