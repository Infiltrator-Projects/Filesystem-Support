...
const std::vector<FilesystemDescriptor>& catalog()
{
    static const std::vector<FilesystemDescriptor> entries = {
        ...
        {"zonefs", "zonefs", "Linux / Zoned Storage",
         ...
         {"zonefs"}, {"zonefs-tools"}, AccessMode::ReadWrite,
         "zonefs is intentionally simple and derives most layout information directly from the zoned device."},
        ...
        {"ntfs3", "NTFS (native ntfs3 driver)", "Microsoft / Kernel",
         ...
         {"ntfs3"}, {}, AccessMode::ReadWrite,
         "Shown as available only when the running Debian kernel actually provides ntfs3."},
        ...
        {"luksde", "LUKS forensic/access utilities", "Linux / Encryption",
         ...
         {}, {"libluksde-utils"}, AccessMode::ToolsOnly,
         "This complements, rather than replaces, the normal Linux device-mapper/cryptsetup path."},
        ...
        {"filevault", "Apple FileVault / FVDE", "Apple / Encryption / FUSE",
         ...
         {}, {"libfvde-utils"}, AccessMode::Userspace,
         "The package includes fvdemount for exposing decrypted container contents through FUSE."},
        {"tmfs", "Apple Time Machine filesystem", "Apple / Backup / FUSE",
         ...
         {}, {"tmfs"}, AccessMode::ReadOnly,
         "tmfs reconstructs hard-linked backup directories from HFS+ Time Machine metadata."},
        ...
        {"wim", "Windows Imaging Format (WIM)", "Microsoft / Image / FUSE",
         ...
         {}, {"wimtools"}, AccessMode::Userspace,
         "wimtools includes both wimmount and wimmountrw as well as extraction and image-maintenance utilities."},
        {"xmount", "Forensic disk-image cross-mount", "Image / FUSE",
         ...
         {}, {"xmount"}, AccessMode::Userspace,
         "Useful as an image-container layer before mounting or examining the filesystem stored inside."},
        ...
        {"vmhgfs", "VMware Shared Folders (HGFS)", "Virtualisation / FUSE",
         ...
         {}, {"open-vm-tools"}, AccessMode::Userspace,
         "Debian's open-vm-tools package contains vmhgfs-fuse."},
        ...
        {"fosfat", "Smaky filesystem (Fosfat)", "Retro / FUSE",
         ...
         {}, {"fosfat"}, AccessMode::ReadOnly,
         "Fosfat provides read-only directory/file access and a FUSE extension."},
        ...
        {"moosefs", "MooseFS", "Distributed / FUSE",
         ...
         {}, {"moosefs-client"}, AccessMode::Userspace,
         "Debian's client package supplies mfsmount and the associated client tools."},
        ...
        {"openafs-fuse", "OpenAFS via FUSE", "Distributed / FUSE / Experimental",
         ...
         {}, {"openafs-client", "openafs-fuse"}, AccessMode::Experimental,
         "Debian documents this FUSE client as read-only and not fully compatible with the normal OpenAFS client tools."},
        ...
        {"httpdirfs", "HTTP directory listings via FUSE", "Network / FUSE",
         ...
         {}, {"httpdirfs"}, AccessMode::ReadOnly,
         "Designed for browsable HTTP directory indexes and supports HTTP basic authentication."},
        ...
        {"disorderfs", "disorderfs", "Overlay / FUSE / Testing",
         ...
         {}, {"disorderfs"}, AccessMode::Userspace,
         "Primarily useful for reproducible-build testing rather than storage compatibility."},
        {"loggedfs", "LoggedFS", "Overlay / FUSE / Diagnostics",
         ...
         {}, {"loggedfs"}, AccessMode::Userspace,
         "Primarily a diagnostic filesystem, but it is a genuine Debian-packaged FUSE implementation."},
        ...
        {"fscrypt", "Linux native filesystem encryption (fscrypt)", "Linux / Encryption",
         ...
         {}, {"fscrypt"}, AccessMode::ToolsOnly,
         "Debian documents ext4, F2FS and UBIFS as supported filesystem backends."},
